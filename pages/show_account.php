                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                    <div class="col-lg-3"><button class="btn-primary" onclick="toastr.info('Save Successful.'); type="submit" form="form1" value="save">Update</button></div>
                                    </form>
                                   
                                    <form action="index.php?page=accounts&action=editPass&id=<?php echo $_SESSION['userID']; ?> " method="post" id="form2" style="float:left;">
                                        <div ><a style="margin-left: 15px" href="index.php?page=tasks&action=allOneUser&id=<?php echo $_SESSION["userID"] ?>">Cancel</a></div>
                                    </form>
                                </div>
                            </div>
                        </div>
